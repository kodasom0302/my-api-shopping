...
public class ProductVo {
	...
	public ProductVo(int p_no, String p_name, int p_price, String p_category, String p_explanation, String filePath,
			String orgName, String saveName, long fileSize, String p_remarks) {
		this.p_no = p_no;
		this.p_name = p_name;
		this.p_price = p_price;
	...
	public String toString() {
		return "ProductVo [p_no=" + p_no + ", p_name=" + p_name + ", p_price=" + p_price + ", p_category=" + p_category
				...
				+ saveName + ", fileSize=" + fileSize + ", p_remarks=" + p_remarks + "]";
	}
